...
def serialize_user(user: dict) -> dict:
    return {
        "id": user["id"],
        "loginId": user.get("login_id") or user.get("username") or user["id"],
        "username": user.get("username") or user["id"],
        "name": user.get("name") or user.get("display_name") or user["id"],
        "displayName": user.get("display_name") or user.get("name") or user["id"],
        "email": user.get("email"),
        "slug": user.get("slug") or slugify(user.get("username") or user["id"]),
